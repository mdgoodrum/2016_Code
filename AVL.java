...
public class AVL<T extends Comparable<? super T>> implements AVLInterface<T> {
     ...
     * @param  node2 [node being rotated around]
     * @return       [node that moved]
     */
    ...
    /**
      ...
      * @param  node1 [node being rotated around]
      * @return       [node that moved
      */
    ...
    /**
     * method that invokes left then right rotation
     * @param  node3 [first rotated node]
     * @return       [second rotated node]
     */
    ...
    /**
     * method that invkoes right then left rotation
     * @param  node1 [first rotated node]
     * @return       [second rotated node]
     */
    ...
    /**
     * sets balance factor for selected node
     * @param parent [node that is being balanced]
     */
     ...
     * feed in a node and traverse down till you run 
     * into the element or you are at a leaf
    ...
    private int height(AVLNode<T> node) {
        if (node != null) {
            int height = (Integer) java.lang.Math.max(
